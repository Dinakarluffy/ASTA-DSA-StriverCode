...
int main()
{
    ...
    vector<vector<int>> ans1 = zeroMatrix(matrix1, n1, m1);
    ...
    cout<<endl;vector<vector<int>> matrix3 = {{1, 1, 1}, {1, 0, 1}, {1, 1, 1}};
    int n3 = matrix3.size();
    int m3 = matrix3[0].size();
    vector<vector<int>> ans3 = zeroMatrix_optimal(matrix3, n3, m3);
